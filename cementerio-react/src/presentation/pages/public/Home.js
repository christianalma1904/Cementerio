        ...
        <Container maxWidth="lg">
          <Grid container spacing={8} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              />
              <Typography variant="h3" fontWeight={700} gutterBottom>
                Servicios con valores y tradición
              </Typography>
              <Typography variant="body1" color="text.secondary">
                Contamos con instalaciones modernas y un equipo humano comprometido para ofrecer
                un acompañamiento íntegro en cada etapa.
              </Typography>
            </Grid>
            {/* ... restante del contenido original (se truncó por brevedad) ... */}
          </Grid>
        </Container>
      </Box>
    </Box>
